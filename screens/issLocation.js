...
import { Text, Image, View, StyleSheet, ImageBackground, StatusBar, SafeAreaView, Alert, Platform } from "react-native";
import MapView, { Marker } from "react-native-maps";
import axios from "axios";

const bgImg = require("../assets/iss_bg.jpg")
const iconImg = require("../assets/iss_icon.png")
            ...
            <View style={styles.mapContainer}>
              <MapView style={styles.map} region={{
                ...
                <Marker coordinate={{
                  ...
                  <Image source={iconImg} style={{ width: 50, height: 50 }} />
                </Marker>
              </MapView>
            </View>
